...
public class sample4 {
	...
	public static void main(String[] args) {
     ...
     //Create Organization with Mandatory fields
       driver.findElement(By.id("Accounts_editView_fieldName_accountname")).sendKeys("abcd");
       //Select "Banking" in the industry drop down
       
       Select dropdown = new Select(driver.findElement(By.name("industry")));
       dropdown.selectByVisibleText("Banking");
